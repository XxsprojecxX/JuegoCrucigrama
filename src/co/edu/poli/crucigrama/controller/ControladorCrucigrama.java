...
/**
 * La clase {@code ControladorCrucigrama} gestiona las interacciones de la interfaz gráfica 
 * del crucigrama, incluyendo la validación de palabras y la navegación entre vistas.
 */
public class ControladorCrucigrama {
    ...
    /**
     * Maneja el evento de clic en el botón de instrucciones, cargando la vista correspondiente.
     * 
    ...
    void BotonInstrucciones(ActionEvent event) throws IOException {
        ...
        ControladorInstrucciones controladorInstrucciones = loader.getController();
    ...
    /**
     * Maneja el evento de validación del crucigrama, cargando la vista de resultados.
     * 
     * @param event el evento de clic del botón.
     * @throws IOException si ocurre un error al cargar la vista.
     */
    ...
    /**
     * Verifica la longitud de la entrada en un campo de texto.
     * 
    ...
    /**
     * Obtiene la lista de palabras introducidas en la interfaz del usuario.
     * 
     * @return una lista de cadenas que representan las palabras introducidas.
     */
    ...
    /**
     * Inicializa el controlador con el escenario principal y el controlador de la vista principal.
     * 
     * @param stage2 el escenario principal.
     * @param controladorVistaPrincipal el controlador de la vista principal.
     */
