...
public class ControladorVistaPrincipal {
	...
	@FXML
	private Text txt_mensajeUsuario;
	...
	void ShowCrucigrama(ActionEvent event) throws IOException {
		...
		if (txtUsuario.getText().length() < 1 || txtUsuario.getText().isEmpty() || txtUsuario.getCharacters().charAt(0) == 32) {
			txt_mensajeUsuario.setVisible(true);
		} else {
